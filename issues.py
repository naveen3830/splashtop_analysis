...
def issues():
    st.title("SEO Issues Overview Dashboard")
    
    # Add information about the data source
    st.markdown("""
    ### Data Overview
    This dashboard provides an analysis of SEO issues extracted from Screaming Frog. 
    The data represents various issues identified for different URLs from splashtop website, including their types, priorities, and the percentage contribution to the total SEO issues. 
    ...
    st.subheader("SEO Issues Data Overview")
    ...
    st.subheader("Distribution of Issue Priority")
    st.write("""
    ...
    st.subheader("Top 10 SEO Issues by Percentage")
    st.write("""
    ...
    st.subheader("Sunburst Chart of SEO Issues")
    st.write("""
